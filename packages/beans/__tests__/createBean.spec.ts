import { createBean, createInitializerDecorator, createLazyProp, Reactive } from "../src";
...
describe('createBean', () => {
    ...
    test('Test create bean doesnt call setup ', () => {
        const uppercase = createInitializerDecorator((instance, constructor, attributeName) => {
            instance[attributeName] = (instance[attributeName] as string).toUpperCase()
        });
        class Foo {
            @uppercase
            bar = "lowercase"
